...
public class FabricanteDAO {
	...
	// Quando todos os dados estiverem preenchido
	...
	// Quando for excluir pelo código

	/*
	 * public void excluir(Long codigo) { Session sessao =
	 * HibernateUtil.getSessionFactory().openSession(); Transaction transacao =
	 * null;
	 * 
	 * try { transacao = sessao.beginTransaction(); Fabricante fabricante =
	 * buscarPorCodigo(codigo); sessao.delete(fabricante); transacao.commit();
	 * 
	 * } catch (RuntimeException ex) { if (transacao != null) {
	 * transacao.rollback(); } throw ex;
	 * 
	...
	public void editar(Fabricante fabricante) {
		...
		try {
			...
			// Quando não for validar em tela
